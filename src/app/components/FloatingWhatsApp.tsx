...
export function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span
        className="absolute right-full mr-3 top-1/2 -translate-y-1/2 px-3 py-1.5 rounded-md bg-white text-black/80 text-[0.78rem] shadow-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none"
