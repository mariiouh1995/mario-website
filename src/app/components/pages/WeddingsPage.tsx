          ...
          <a href="/destination-wedding" className="group block border border-black/10 bg-white px-5 py-5 md:px-8 md:py-6 no-underline text-black hover:border-black/25 transition-colors">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm text-black/60 max-w-2xl">Mallorca, Toskana, Island oder ein Ort, der nur euch etwas bedeutet. Ich begleite euch auch außerhalb von Tirol und Bayern.</p>
              </div>
