(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ?  factory(exports, require('@tiptap/core'), require('@tiptap/extension-list'), require('@tiptap/extension-details'), require('@tiptap/extension-table'), require('@tiptap/extension-blockquote'), require('@tiptap/extension-code-block'), require('@tiptap/extension-document'), require('@tiptap/extension-emoji'), require('@tiptap/extension-hard-break'), require('@tiptap/extension-heading'), require('@tiptap/extension-horizontal-rule'), require('@tiptap/extension-image'), require('@tiptap/extension-paragraph'), require('@tiptap/extension-text'), require('@tiptap/extension-bold'), require('@tiptap/extension-code'), require('@tiptap/extension-highlight'), require('@tiptap/extension-italic'), require('@tiptap/extension-link'), require('@tiptap/extension-strike'), require('@tiptap/extension-subscript'), require('@tiptap/extension-superscript'), require('@tiptap/extension-text-style'), require('@tiptap/extension-underline')) :
  typeof define === 'function' && define.amd ? define(['exports', '@tiptap/core', '@tiptap/extension-list', '@tiptap/extension-details', '@tiptap/extension-table', '@tiptap/extension-blockquote', '@tiptap/extension-code-block', '@tiptap/extension-document', '@tiptap/extension-emoji', '@tiptap/extension-hard-break', '@tiptap/extension-heading', '@tiptap/extension-horizontal-rule', '@tiptap/extension-image', '@tiptap/extension-paragraph', '@tiptap/extension-text', '@tiptap/extension-bold', '@tiptap/extension-code', '@tiptap/extension-highlight', '@tiptap/extension-italic', '@tiptap/extension-link', '@tiptap/extension-strike', '@tiptap/extension-subscript', '@tiptap/extension-superscript', '@tiptap/extension-text-style', '@tiptap/extension-underline'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.StoryblokRichtext = {}), global.TiptapCore,global.TiptapList,global.TiptapDetails,global.TiptapTable,global.TiptapBlockquote,global.TiptapCodeBlock,global.TiptapDocument,global.TiptapEmoji,global.TiptapHardBreak,global.TiptapHeading,global.TiptapHorizontalRule,global.TiptapImage,global.TiptapParagraph,global.TiptapText,global.TiptapBold,global.TiptapCode,global.TiptapHighlight,global.TiptapItalic,global.TiptapLink,global.TiptapStrike,global.TiptapSubscript,global.TiptapSuperscript,global.TiptapTextStyle,global.TiptapUnderline));
})(this, function(exports, _tiptap_core, _tiptap_extension_list, _tiptap_extension_details, _tiptap_extension_table, _tiptap_extension_blockquote, _tiptap_extension_code_block, _tiptap_extension_document, _tiptap_extension_emoji, _tiptap_extension_hard_break, _tiptap_extension_heading, _tiptap_extension_horizontal_rule, _tiptap_extension_image, _tiptap_extension_paragraph, _tiptap_extension_text, _tiptap_extension_bold, _tiptap_extension_code, _tiptap_extension_highlight, _tiptap_extension_italic, _tiptap_extension_link, _tiptap_extension_strike, _tiptap_extension_subscript, _tiptap_extension_superscript, _tiptap_extension_text_style, _tiptap_extension_underline) {
...
_tiptap_extension_document = __toESM(_tiptap_extension_document);
_tiptap_extension_emoji = __toESM(_tiptap_extension_emoji);
_tiptap_extension_hard_break = __toESM(_tiptap_extension_hard_break);
_tiptap_extension_heading = __toESM(_tiptap_extension_heading);
_tiptap_extension_horizontal_rule = __toESM(_tiptap_extension_horizontal_rule);
_tiptap_extension_image = __toESM(_tiptap_extension_image);
_tiptap_extension_paragraph = __toESM(_tiptap_extension_paragraph);
_tiptap_extension_text = __toESM(_tiptap_extension_text);
_tiptap_extension_bold = __toESM(_tiptap_extension_bold);
_tiptap_extension_code = __toESM(_tiptap_extension_code);
_tiptap_extension_highlight = __toESM(_tiptap_extension_highlight);
...
_tiptap_extension_subscript = __toESM(_tiptap_extension_subscript);
...
//#region src/extensions/nodes.ts
	const StoryblokBlockquote = _tiptap_extension_blockquote.default.extend({ renderHTML({ HTMLAttributes }) {
		return [
			"blockquote",
	...
	const StoryblokParagraph = _tiptap_extension_paragraph.default.extend({ renderHTML({ HTMLAttributes }) {
		return [
			"p",
			processBlockAttrs(HTMLAttributes),
			0
	...
	const StoryblokHeading = _tiptap_extension_heading.default.extend({ renderHTML({ node, HTMLAttributes }) {
	...
	const StoryblokTableRow = _tiptap_extension_table.TableRow.extend({ renderHTML({ HTMLAttributes }) {
		return [
			"tr",
			processBlockAttrs(HTMLAttributes),
			0
	...
	const StoryblokBulletList = _tiptap_extension_list.BulletList.extend({
		name: "bullet_list",
		addOptions() {
			return {
				...this.parent(),
	...
	const StoryblokOrderedList = _tiptap_extension_list.OrderedList.extend({
		name: "ordered_list",
		addOptions() {
			return {
				...this.parent(),
	...
	const StoryblokListItem = _tiptap_extension_list.ListItem.extend({
		name: "list_item",
		addOptions() {
			return {
				...this.parent(),
	...
	const StoryblokCodeBlock = _tiptap_extension_code_block.default.extend({
		name: "code_block",
	...
	const StoryblokHardBreak = _tiptap_extension_hard_break.default.extend({ name: "hard_break" });
	const StoryblokHorizontalRule = _tiptap_extension_horizontal_rule.default.extend({ name: "horizontal_rule" });
	const StoryblokTable = _tiptap_extension_table.Table.extend({ renderHTML({ HTMLAttributes }) {
		return [
			"table",
			processBlockAttrs(HTMLAttributes),
			0
	...
	const StoryblokTableCell = _tiptap_extension_table.TableCell.extend({ renderHTML({ HTMLAttributes }) {
		return [
			"td",
	...
	const StoryblokTableHeader = _tiptap_extension_table.TableHeader.extend({ renderHTML({ HTMLAttributes }) {
		return [
			"th",
			computeTableCellAttrs(HTMLAttributes),
			0
	...
	const StoryblokImage = _tiptap_extension_image.default.extend({
		addOptions() {
			return {
				...this.parent?.(),
	...
	const StoryblokEmoji = _tiptap_extension_emoji.default.extend({ renderHTML({ HTMLAttributes }) {
		return [
			"span",
			{
				"data-type": "emoji",
	...
	const ComponentBlok = _tiptap_core.Node.create({
		name: "blok",
		group: "block",
		atom: true,
		addOptions() {
...
//#region src/extensions/marks.ts
	const StoryblokLink = _tiptap_extension_link.default.extend({
		addAttributes() {
			return {
	...
	const StoryblokAnchor = _tiptap_core.Mark.create({
		name: "anchor",
		addAttributes() {
	...
	const StoryblokStyled = _tiptap_core.Mark.create({
		name: "styled",
		addAttributes() {
	...
	const StoryblokTextStyle = _tiptap_core.Mark.create({
		name: "textStyle",
		addAttributes() {
			return {
				class: { default: null },
...
//#region src/extensions/index.ts
	const defaultExtensions = {
		...
		blok: ComponentBlok,
		details: _tiptap_extension_details.Details,
		detailsContent: _tiptap_extension_details.DetailsContent,
		...
		highlight: _tiptap_extension_highlight.default,
...
/**
	...
	*/
	function callExtensionRenderHTML(ext, type, attrs) {
		const thisContext = {
			options: ext.options || {},
			name: ext.name,
			type: ext.type
	...
	*/
	function richTextResolver(options = {}) {
		...
		function renderNode(node) {
			...
			return specToRender(callExtensionRenderHTML(ext, "node", node.attrs || {}), contextRenderFn, children);
		}
		function renderText(node) {
			...
			if (marks?.length) {
				...
				return marks.reduce((text, mark) => {
					...
					return specToRender(callExtensionRenderHTML(ext, "mark", mark.attrs || {}), contextRenderFn, text);
				}, baseText);
			}
...
exports.ComponentBlok = ComponentBlok;
...
exports.segmentStoryblokRichText = segmentStoryblokRichText;
});
