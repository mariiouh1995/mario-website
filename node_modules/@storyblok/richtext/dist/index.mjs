...
const StoryblokTableCell = TableCell.extend({ renderHTML({ HTMLAttributes }) {
	return [
		"td",
...
//#endregion
export { BlockTypes, ComponentBlok, LinkTargets, LinkTypes, MarkTypes, TextTypes, asTag, richTextResolver, segmentStoryblokRichText };
